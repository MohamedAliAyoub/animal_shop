                ...
                <div class="col">
                    <div class="breadcrumb-contain">
                        <div>
                            <h2>{{$product->name}}</h2>
                            <ul>
                                <li><a href="{{  route('website')  }}">الرئيسية</a></li>
                    ...
                    <div class="col-lg-5">
                        <div class="product-slick">
                            @foreach($product->images as $image)
                                <div><img src="{{asset('images/'.$image->image)}}" alt="" class="img-fluid  image_zoom_cls-0"></div>
                            @endforeach
                        </div>
                    ...
                    <div class="col-lg-7 rtl-text">
                        <div class="product-right ">
                            <div class="pro-group">
                                ...
                                <ul class="pro-price">
                                    <li><P>رقم التواصل:{{$product->number}}</P></li>
                            ...
                            <div class="pro-group">
                                <h6 class="product-title">تفاصيل المشروع</h6>
