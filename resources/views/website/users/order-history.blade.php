                          ...
                          <table class="table table-bordered cart_summary table-striped">
                            ...
                            @endphp
                              <tr class="first odd">
                                ...
                                <td style="text-align: center;"><em>{{isset($orders->status)?$order->status->name:''}}</em></td>
                                <td class="a-center last" style="text-align: center;"><span class="nobr btn"> <a style="color: white" href="{{url('/'.$locale.'/order/history/'.$order->id)}}">{{__('User.View Order')}}</a></td>
                              </tr>
                              @endforeach
                              @endif
