    ...
    <div class="cart_media">
      <ul class="cart_product">
        <li>
          <div class="media">
            <a href="product-page(left-sidebar).html">
              <img alt="megastore1" class="me-3" src="{{asset("website/images/layout-5/product/1.jpg")}}">
            </a>
        ...
        <li>
          <div class="media">
            <a href="product-page(left-sidebar).html">
              <img alt="megastore1" class="me-3" src="{{asset("website/images/layout-5/product/2.jpg")}}">
            </a>
            <div class="media-body">
              <a href="product-page(left-sidebar).html">
        ...
        <li>
          <div class="media">
            <a href="product-page(left-sidebar).html">
              <img alt="megastore1" class="me-3" src="{{asset("website/images/layout-5/product/3.jpg")}}">
            </a>
            <div class="media-body">
              <a href="product-page(left-sidebar).html">
                <h4>vivo y30</h4>
